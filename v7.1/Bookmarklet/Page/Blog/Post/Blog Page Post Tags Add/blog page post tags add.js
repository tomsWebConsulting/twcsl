( ( ) => {
  ...
  const
    ...
    panelElement = xPathResults
    
      .snapshotItem ( 0 )
      
      .closest ( 'div[ class^="Transition-panel-" ]' ),
      
    inputElement = panelElement
