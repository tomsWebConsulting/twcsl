# Events Page List Grid

### [License][1]

### Synopsis

Style Events Page List as a grid.
...
* CDN Hosted
  ...
  * Options
    ...
    * Page Specific
      ...
      * Add code from file **[events page list grid options.html][6]** to
      ...
      * Add the following code to Page Settings > Advanced >
        ...
        ```html
        <!-- begin TWC Events Page List Grid -->
...
* On-site
  ...
  * Page Specific
    ...
    * Add code from file **[events page list grid options.html][6]**
      to Page Settings > Advanced > Page Header Code Injection for the Page.
      Read the code for any instructions within.
      
    * Add code from file **[events page list grid.html][9]** to
...
[6]: events%20page%20list%20grid%20options.html#L1
...
[9]: events%20page%20list%20grid.html#L1
