...
* On-site
  ...
  * Page Specific
    ...
    * Add code from file **[store page list image hover title add.html][8]**
...
[8]: store%20page%20list%20image%20hover%20title%20add.html#L1
[9]: https://toms-web-consulting-demos.squarespace.com/store-page-list-image-hover-title-add?password=twcdemos
