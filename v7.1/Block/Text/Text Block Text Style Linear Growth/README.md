# Text Block Text Style Linear Growth

### [License][1]

### Synopsis

Make Text Block text have a more linear growth instead of suddenly topping out
at larger browser window widths.
...
* Install and use **[CSS Breakpoint Get][3]**. After you install and use the
