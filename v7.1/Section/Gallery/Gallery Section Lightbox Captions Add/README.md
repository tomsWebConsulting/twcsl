    ...
    * Page Specific
      ...
      * Add the following code to Page Settings > Advanced >
        ...
        <!-- begin TWC Gallery Section Lightbox Control Icons Change -->
          ...
          <script src="https://cdn.jsdelivr.net/gh/tomsWebConsulting/twcsl@e3724791df18cff5fcae5beecab78797cd0237d5/v7.1/Section/Gallery/Gallery%20Section%20Lightbox%20Control%20Icons%20Change/gallery%20section%20lightbox%20control%20icons%20change.min.js" type="module"></script>
...
Making and using SVGs is a complex topic, I can not help you with them. You may
need to create custom CSS to get your custom SVGs to display the way want.
