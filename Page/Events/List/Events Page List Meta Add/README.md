# Events Page List Meta Add

### [License][1]

### Synopsis

Add additional meta information to Events Page list.
...
* CDN Hosted
  ...
  * Options
    ...
    * Page Specific
      ...
      * Add code from file **[events page list meta add options.html][6]**
      ...
      * Add the following code to Page Settings > Advanced >
        ...
        ```html
        <!-- begin TWC Events Page List Meta Add -->
        
          <!-- License < https://github.com/tomsWebConsulting/twcsl/blob/main/LICENSE.txt#L1 > -->
          
          <script src="https://cdn.jsdelivr.net/gh/tomsWebConsulting/twcsl@b45426453bb2150c65e7c6bd48b9e35cd670d547/Page/Events/List/Events%20Page%20List%20Meta%20Add/events%20page%20list%20meta%20add.min.js" type="module"></script>
    ...
    * Site-wide
      ...
      * v7.1
        ...
        * Add code from file **[events page list meta add options.html][6]** to
...
* On-site
  ...
  * Page Specific
    ...
    * Add code from file **[events page list meta add.html][9]** to
  ...
  * Site-wide
    ...
    * v7.1
      ...
      * Add code from file **[events page list meta add.html][9]** to Website >
...
[6]: events%20page%20list%20meta%20add%20options.html#L1
...
[9]: events%20page%20list%20meta%20add.html#L1
