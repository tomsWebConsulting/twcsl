  ...
  * Options
    ...
    * Page Specific
      ...
      * Add the following code to Page Settings > Advanced >
        ...
        ```html
        <!-- begin TWC Events Page List All Day Time Hide -->
...
* On-site
  ...
  * Page Specific
    ...
    * Add code from file **[events page list all day time hide.html][8]** to
...
[8]: events%20page%20list%20all%20day%20time%20hide.html#L1
