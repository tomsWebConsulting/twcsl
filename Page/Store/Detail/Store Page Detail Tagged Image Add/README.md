...
* Options
  ...
  * Site-wide
    ...
    * v7.1
      ...
      * Add code from file **[store page detail tagged image add
        options.html][5]** to Website > Pages > Custom Code > Code Injection >
    ...
    * v7.0
      ...
      * Add code from file **[store page detail tagged image add
        options.html][5]** to Website > Pages > Website Tools > Custom Code >
...
[5]: store%20page%20detail%20tagged%20image%20add%20options.html#L1
[6]: store%20page%20detail%20tagged%20image%20add.html#L1
